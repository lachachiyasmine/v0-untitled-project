...
import { Upload, ImageIcon, RefreshCw, Settings, AlertCircle } from "lucide-react"
...
export default function LaneDetection() {
  ...
  // Load OpenCV.js from local file
  useEffect(() => {
    ...
    script.onerror = (e) => {
      ...
      setIsOpenCvLoading(false)
      setError("Failed to load OpenCV.js. Please make sure the file exists in the public folder.")
    }
    ...
    const timeoutId = setTimeout(() => {
      if (!isOpenCvReady) {
        setIsOpenCvLoading(false)
        setError(
          "OpenCV.js initialization timed out. Please make sure the file is correctly downloaded and not corrupted.",
        )
      }
  ...
  const loadImage = (url: string) => {
    if (!isOpenCvReady) {
      setError("OpenCV.js is not ready yet. Please wait a moment and try again.")
      return
    }
  ...
  const processImage = (detector = laneDetector) => {
    ...
    try {
      ...
      setError(`Error setting up image processing: ${err instanceof Error ? err.message : String(err)}`)
      setIsProcessing(false)
    }
  }
    ...
    <div className="space-y-6">
      {isOpenCvLoading && (
        <Alert>
          ...
          <AlertTitle>Loading OpenCV.js</AlertTitle>
          <AlertDescription>Please wait while OpenCV.js is loading. This may take a few moments.</AlertDescription>
        </Alert>
      )}
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="upload" className="space-y-4">
          ...
          <div className="mt-8">
            <h3 className="text-lg font-medium mb-4">Or try with sample images</h3>
              ...
              {SAMPLE_IMAGES.map((img, index) => (
                ...
                >
                  <img
                    ...
                    alt={`Road sample ${index + 1}`}
                    className="w-full h-40 object-cover"
                  />
                  <div className="p-2 text-center text-sm">Road Sample {index + 1}</div>
                </div>
              ))}
            </div>
          </div>
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card>
                  <CardContent className="pt-6">
                    <h3 className="text-lg font-medium mb-4 flex items-center">
                      <ImageIcon className="mr-2 h-5 w-5" /> Original Image
                    </h3>
                ...
                <Card>
                  <CardContent className="pt-6">
                    <h3 className="text-lg font-medium mb-4 flex items-center">
                      <ImageIcon className="mr-2 h-5 w-5" /> Processed Image
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-medium flex items-center">
                      <Settings className="mr-2 h-5 w-5" /> Detection Parameters
                    </h3>
                  ...
                  <Accordion type="single" collapsible defaultValue="edge-detection">
                        ...
                        <div className="space-y-4">
                          <div className="space-y-2">
                            <div className="flex justify-between">
                              <label className="text-sm">Canny Threshold 1</label>
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between">
                              <label className="text-sm">Canny Threshold 2</label>
                    ...
                    <AccordionItem value="line-detection">
                      <AccordionTrigger>Line Detection</AccordionTrigger>
                      <AccordionContent>
                        <div className="space-y-4">
                          <div className="space-y-2">
                            <div className="flex justify-between">
                              <label className="text-sm">Hough Threshold</label>
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between">
                              <label className="text-sm">Min Line Length</label>
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between">
                              <label className="text-sm">Max Line Gap</label>
                            ...
                            <div className="text-xs text-muted-foreground mt-1">
                              {params.houghMaxLineGap >= 0
                                ? "Positive: Maximum allowed gap between line segments"
                                : "Negative: Required minimum overlap between line segments"}
                            </div>
                          </div>
                        </div>
                      </AccordionContent>
                    ...
                    <AccordionItem value="roi">
                      <AccordionTrigger>Region of Interest</AccordionTrigger>
                      <AccordionContent>
                        <div className="space-y-4">
                          <div className="space-y-2">
                            <div className="flex justify-between">
                              <label className="text-sm">ROI Height (% from bottom)</label>
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between">
                              <label className="text-sm">ROI Width Offset (% from sides)</label>
                              <span className="text-sm text-muted-foreground">
